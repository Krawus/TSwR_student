...
class Poly3(TrajectoryGenerator):
    ...
    def generate(self, t):
        ...
        q_dot = -3*self.a_0*(1-t)**2 + self.a_1*(3*t**2 - 4*t + 1) + self.a_2*(2*t - 3*t**2) + 3*self.a_3*t**2
        q_ddot = 6*self.a_0*(1-t) + self.a_1*(6*t - 4) + self.a_2*(2 - 6*t) + 6*self.a_3*t
